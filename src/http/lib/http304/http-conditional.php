...
namespace ItakenPHPie\http\lib\http304;
...
{//Credits: http://alexandre.alapetite.fr/doc-alex/php-http-304/
    ...
    if ($is412) {//rfc2616-sec10.html#sec10.4.13
        ...
        if ($cacheSeconds<0) {
            ...
            //header('Expires: 0');
            } elseif ($cachePrivacy===0) {
                $cache='private, ';
            } elseif ($cachePrivacy===2) {
                $cache='public, ';
            } else {
                $cache='';
            }
        ...
        if ($feedMode) {
            header('Connection: close');
        } //rfc2616-sec14.html#sec14.10 //Comment this line under IIS
